...
namespace WebApp.GetingeGroup.admin.model
{
    public class GetingeGroupDBHerlper
    {
        private static readonly string StrConn = @"server=rdszs7hma4oekk42tfx4public.sqlserver.rds.aliyuncs.com,3433;database=VoteAndQuestionDB;User ID=binland;pwd=password_1";
        //private static readonly string StrConn = @"server=.;database=VoteAndQuestionDB;User ID=sa;pwd=password_1";
