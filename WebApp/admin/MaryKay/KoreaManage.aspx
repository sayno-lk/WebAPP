<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KoreaManage.aspx.cs" Inherits="WebApp.admin.MaryKay.KoreaManage" %>
        ...
        <div class="mycontent">
            ...
            <div style="text-align: right; color: Black; clear: both; padding: 10px 30px; overflow: hidden;">
                <div style="float: left;">
                    ...
                    <asp:Button ID="btnQuestion" runat="server" Text="开启问卷" Height="40px" Width="106px"
                        OnClick="btnQuestion_Click" />
                    <asp:Button ID="btnPhoto" runat="server" Text="开启照片" Height="40px" Width="106px"
