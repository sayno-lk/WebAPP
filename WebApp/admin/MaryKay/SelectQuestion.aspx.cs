...
namespace WebApp.admin.MaryKay
{
    public partial class SelectQuestion : System.Web.UI.Page
    {
        ...
        public void LoadFirstQData()
        {
            ...
            PageIndex = 1;
            list = (from r in _db.tbl_record
                    join emp in _db.tbl_employeeMK on new { EId = r.eId.Value } equals new { EId = emp.eId }
                    join ans in
                        (
                            (from a in _db.tbl_answer
                             group a by new
                             {
                                 a.rId
                             } into g
            ...
            var sumEmp = (from b in _db.tbl_employeeMK select b).ToList().Count();
        ...
        public int nuCount()
        {
            NumCount = (from r in _db.tbl_record
                        join emp in _db.tbl_employeeMK on new { EId = r.eId.Value } equals new { EId = emp.eId }
                        join ans in
                            (
                                (from a in _db.tbl_answer
        ...
        /// </summary>
        /// <returns></returns>
        public void CreateExcelByList()
        {
            LoadFirstQData();
        }
        protected void btnExit_Click(object sender, EventArgs e)
        {
            Response.Redirect("SelectQuestion.aspx");
        }
        ...
        protected void btnSelectPro2_Click(object sender, EventArgs e)
        {
