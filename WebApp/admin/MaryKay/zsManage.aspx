<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="zsManage.aspx.cs" Inherits="WebApp.admin.MaryKay.zsManage" %>
...
<body>
    ...
    <div class="myform">
        <div class="mycontent">
            ...
            <div>
                <WebApp:menu ID="UserTabBar" runat="server" ClassID="2" />
            </div>
                        ...
                        <div class="item">
                            ...
                            <div class="fl i-right i-shadow">
                               <%-- <input type="text" id="txtProName" value="" class="i-input" />--%>
                                <span class="i-proName">MaryKay1</span>
                            </div>
                        </div>
                        <div class="item">
                            <div class="fl i-left">
                                <span class="i-span1">证书图片</span>
                            </div>
                            <div class="fl i-right ">
                                <div class="i-proBg">
                                    <img src="/MaryKayUploadImg/zs.jpg" id="pro_img" alt="" />
