    ...
    */
    ...
    start_callback: function () {
        ...
        setTimeout(function () {
            ...
            isNextPage = 1;
            $(".sec02").removeClass("opacity");
            $(".sec02").addClass("page-show");
            //$(".sec02 div").addClass(" shake shake-hard");
            //$(".sec02 div").addClass(" shake shake-slow");
            $(".sec02 .p1").addClass(" shake shake-slow1");
            $(".sec02 .p2").addClass(" shake shake-slow2");
            $(".sec02 .p3").addClass(" shake shake-slow3");
...
(function (window) {
    var leave = {
        /*设置留言区的高度*/
        oHeight: function () {
            var curH = $('.p-ct').outerHeight(true);
        ...
        setColor: function () {
            $('.leave-con,.close_btn,.m-leave-item .lea-time,.go_in').css('background-color', $('.leave_box').attr('data-color'));
            $('.m-leave-item .name,.m-fill-btn').css('color', $('.leave_box').attr('data-color'));
            $('.m-leave-item:even').find('.lea-time .after').css('border-color', 'transparent ' + $('.leave_box').attr('data-color') + ' transparent transparent');
            $('.m-leave-item:odd').find('.lea-time .after').css('border-color', 'transparent transparent transparent ' + $('.leave_box').attr('data-color') + '');
        }
    };
